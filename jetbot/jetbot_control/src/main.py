...
pub_vel_left_1 = rospy.Publisher('/robot1/joint1_velocity_controller/command', Float64, queue_size=10)
pub_vel_right_1 = rospy.Publisher('/robot1/joint2_velocity_controller/command', Float64, queue_size=10)

pub_vel_left_2 = rospy.Publisher('/robot2/joint1_velocity_controller/command', Float64, queue_size=10)
pub_vel_right_2 = rospy.Publisher('/robot2/joint2_velocity_controller/command', Float64, queue_size=10)
...
while not rospy.is_shutdown():
    ...
    pub_vel_left_1.publish(20)
    pub_vel_right_1.publish(20)

    pub_vel_left_2.publish(20)
    pub_vel_right_2.publish(20)
    #pub.publish(speed)
