...
class DeepSoccerTestEnv(robot_gazebo_env.RobotGazeboEnv):
    ...
    def __init__(self, ros_ws_abspath):
        ...
        * /kobuki/laser/scan: Laser Readings
        ...
        ROSLauncher(rospackage_name="jetbot_gazebo",
                    launch_file_name="main_soccer_test.launch",
        ...
        super(DeepSoccerTestEnv, self).__init__(controllers_list=self.controllers_list,
        ...
        #rospy.Subscriber('/jetbot/laser/scan', LaserScan, self._laser_scan_callback)
    ...
    def _check_laser_scan_ready(self):
        # rospy.Subscriber('/jetbot/laser/scan', LaserScan, self.laser_callback)
        self.laser_scan = None
        rospy.logdebug("Waiting for /jetbot/laser/scan to be READY...")
        while self.laser_scan is None and not rospy.is_shutdown():
            try:
                self.laser_scan = rospy.wait_for_message("/jetbot/laser/scan", LaserScan, timeout=5.0)
                rospy.logdebug("Current /jetbot/laser/scan READY=>")

            except:
                rospy.logerr("Current /jetbot/laser/scan not ready yet, retrying for getting laser_scan")
    ...
    # ----------------------------
    def move_base(self, wheel1_speed, wheel2_speed, wheel3_speed, wheel4_speed):
        """
